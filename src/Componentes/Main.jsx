...
const Main = () => {
    return (
       <div className="font-serif mt-4 ml-12 mr-12 text-justify indent-6">
        ...
        <br></br>
        <p className="ml-4 mr-4">Kangaroo mother care, which consists of skin-to-skin contact and breastfeeding on her part:</p>
        <br></br>
        <ul className="text-left ml-8">
        ...
        <br></br>
        <p className="ml-4 mr-4">In 2015 a publication in the journal Pediatrics showed conclusive data:</p>
        <br></br>
         <ul className="text-left ml-8">
         ...
         <br></br>
         <p className="ml-4 mr-4">Likewise, in 2017, another study on premature and full-term babies concluded that physical contact has effect on the brain of the newborn and its perceptual, cognitive and social development in the future. So how important is physical contact for the baby.</p>
         <br></br>
         <hr className="my-8 h-1 h-px bg-rose-300 h-px border-0"></hr>
         <br></br>
         <h3 className="text-center text-xl font-bold text-pink-800">Does the physical contact that the human being receives in the first years of life have some kind of relationship with that violent societies exist?</h3>
         <br></br>
         ...
         <hr className="my-8 h-1 h-px bg-rose-300 h-px border-0"></hr>
         <br></br>
         <h3 className="text-center text-xl font-bold text-pink-800">The importance of positive affectivity and the story of Anna's children</h3>
         <br></br>
         ...
         <br></br>
         <p>Dr. Fritz Talbot, a Boston pediatrician, then began an exhaustive investigation into the mysterious marasmus (type of malnutrition due to energy deficiency, resulting in a total caloric deficit). He toured countless orphanages in various countries of the world finding that mortality was in the same levels. The revelation came when visiting a hospice in Dusseldorf (Germany) before the first war: in that place the children seemed healthier and stronger and yet received the same attention than children hospitalized in other centers. During your visit to the rooms with the director of the center observed an elderly woman carrying a baby on her hip. Talbot asked the medical director who was this woman. “Oh, that's old Anna. When we've done everything we can since medical point of view for a child, and still not well, we give it to old Anna. She always succeeds. ” Miracle! The children Anna carried survived.</p>
         <br></br>
         <hr className="my-8 h-1 h-px bg-rose-300 h-px border-0"></hr>
         <br></br>
         <h3 className="text-center text-xl font-bold text-pink-800">Body care for teachers</h3>
         <br></br>
         ...
         <p>As we can see, the accommodation of the posture not only helps us to have the spine in axis, making the physical body feel healthier but also and at the same time we are developing and stimulating mental concentration, which allows us to be more aware of the present. "Mental concentration is a psychic process that is carried out through reasoning; consists in voluntarily focus the full attention of the mind on a goal, object or activity that is being doing or thinking of doing at that time, leaving aside the whole series of facts or other objects that may be able to interfere with their achievement or their attention. Concentration is vital for study and work. " The exercise lasts approximately ten minutes, causes the person begins to have greater awareness of their own body, managing to make present and feel areas that perhaps before they went more unnoticed. This practice acquired as a daily habit, in addition to stimulating concentration, generates a better posture of the spine, and develops greater body awareness, helping us to re-educate the body and we can also better control our emotions.</p>
         <br></br>
         <p>The concept of the control and observation of the breath which is another tool of yoga called in the Sanskrit word “Pranayama”, it literally means “breath control” (prāṇá: air, breath, life, inspired air, vital force; iāma: control). It is one of the techniques fundamental that enables us to connect with ourselves, achieving through it produce different effects on the body. Among the most used and outstanding exercises are those that invite us to enter a state of relaxation, self-control and concentration. (Since they exist many types of pranayamas, which can also balance us or invite us to have a greater energy in the body, among other possible effects).</p>
         <br></br>
         ...
         <hr className="my-8 h-1 h-px bg-rose-300 h-px border-0"></hr>
         <br></br>
         <h3 className="text-center text-xl font-bold text-pink-800">Experiential Experiences</h3>
         <br></br>
         <ul className="text-left ml-8">
